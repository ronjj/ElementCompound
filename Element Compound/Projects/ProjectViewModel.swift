...
//    @Published var project: Project = Project(title: "",creator: Auth.auth().currentUser?.displayName ?? "N/A",  /*color: Color.blue,*/ dateEvent: Date(), dueDate: Date(), completionLevel: "Idea", assignedStudents: [], priority: "Low", notes: "..." )
...
//    }
//
//    //removed private from this func
