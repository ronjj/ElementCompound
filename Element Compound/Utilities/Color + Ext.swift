...
extension UIColor {
    ...
    static let bginv = UIColor(named: "bginv")
    static let nyanza = UIColor(named: "nyanza")
    static let ruby = UIColor(named: "ruby")
    static let yellow2 = UIColor(named: "yellow2")
    static let courseGreen = UIColor(named: "courseGreen")
